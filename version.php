...
$plugin->component = 'block_mycredits'; // Full name of the plugin (used for diagnostics).
$plugin->release = "4.5.0 (Build 2025042900)";
$plugin->dependencies = ['enrol_trainingcredits' => ANY_VERSION];
